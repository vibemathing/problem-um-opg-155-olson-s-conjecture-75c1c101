...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-155-olson-s-conjecture-75c1c101-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-155"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-155-olson-s-conjecture-75c1c101-v1",
      "problem_contract_sha256": "9c0b66edb8ae0bfc4ce47851f8b4ad968230ee7f714ff5f83d62f82994a4caf9",
      "problem_id": "problem:um-opg-155-olson-s-conjecture-75c1c101",
      "route_id": "route:um-opg-155-olson-s-conjecture-75c1c101-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-155-olson-s-conjecture-75c1c101-source-fidelity-01",
      "graph_id": "graph:um-opg-155-olson-s-conjecture-75c1c101-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-155-olson-s-conjecture-75c1c101-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-155-olson-s-conjecture-75c1c101-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture If $a_1,a_2,\\ldots,a_{2n-1}$ is a sequence of elements from a multiplicative group of order $n$, then there exist $1 \\le j_1 < j_2 \\ldots < j_n \\le 2n-1$ so that $\\prod_{i=1}^n a_{j_i} = 1$."
          },
          "statement_sha256": "87e9e259d831cfbaa27774c20a3621f5c5cb2df90ceeb65c4013c5e26e048012"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-155-olson-s-conjecture-75c1c101-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-155-olson-s-conjecture-75c1c101-root",
      "route_id": "route:um-opg-155-olson-s-conjecture-75c1c101-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-155-6c23adc9dad9",
        "url": "https://www.unsolvedmath.com/problems/OPG-155"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
